...
| ------------ | TM‎471‎ `IT`  مشروع التخرج   14:00‏ الى ‎15:00  | ------------ |------------ |
|  معايير التدقيق الدولية   pm 1:30 - 4:30 - `Ph.D.` | ------------ | ------------ |  `Med`   (434) علم الاحياء الدقيقه (2) |
| ------------ | ------------ | ------------ |  ريادة الأعمال `Med`  (ON LINE ) ن ر 02:00-03:00 |
|  محاسبة التكاليف المتقدمة   pm 4:30 - 7:30 - `Ph.D.` | ------------ | ------------ `Med`   (431) علم كيمياء تحليليه |
| ------------ | ------------ | ------------ | لمواطنة الايجابية ومهارات الحياة  03:30-05:00  `Med`  |
.
