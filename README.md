...
> ## Second Term  ` 2024 `   Study Schedule
...
| ------------ | ------------ | ------------ |------------ | ------------ | ------------ | 
| ------------ | بنك الدم (429) 09:00-11:00 `Med`  | ------------ |   بنك الدم (429) 09:00-11:00 `Med` |  --------- | بنك الدم (429) 09:00-11:00 `Med`|
| ------------ | علم الطفيليات الطبي (429)  11:00-12:00  `Med` | ------------ | علم الطفيليات الطبي (429)  11:00-12:00  `Med`  | ------------ |  علم الطفيليات الطبي (429)  11:00-12:00  `Med` |
| ------------ | ------------ | ------------ |   العلوم العسكرية 2019  `Med`   (ON LINE مشترك9)  12:00-01:00 | ------------ | ------------ | 
| ------------ | علم الانسجة والتحضير المجهري  (431) `Med`  01:00-03:00 | ------------ | علم الانسجة والتحضير المجهري  (431) `Med`  01:00-03:00 |  ----------------   |  علم الانسجة والتحضير المجهري  (431) `Med`  01:00-03:00 | 
| ------------ | علم الانسجة والتحضير المجهري  (431) `Med`  01:00-03:00 | ------------ | علم الانسجة والتحضير المجهري  (431) `Med`  01:00-03:00 |  ----------------   |  الاجهزة المخبرية  `Med`  03:00-04:00 | 
| ------------ | ------------ | ------------ |------------ | ------------ | ------------ | 
| ------------ | ------------ | التربية الوطنية (ON LINE)  `Med`  10:00-11:00 |------------ |  التربية الوطنية (ON LINE)  `Med`  10:00-11:00 | ------------ | 
| ------------ | ------------ | مختبر علم الاحياء الدقيقه (مختبر 421)  `Med`  12:00-03:00 |------------ | مختبر علم الاحياء الدقيقه (مختبر 421)  `Med`  12:00-03:00 | ------------ | 
|  7:30 Pm- 4:30 - `Ph.D.`- تدقيق الحسابات المتقدم  |  8:30 Pm- 5:30 - `Ph.D.`-  معايير المحاسبة والابلاغ المالي المتقدم   | -------------- |  8:30 Pm- 5:30 - `Ph.D.`-   المحاسبة الضريبية والزكاة  | ------------ |------------ | 
...
<img width="1011" alt="New schedual" src="https://github.com/nancyalaswad90/Each-Year-Study-Schedule/assets/36210723/0e635cdf-e19b-4092-8bac-cb476f0ec325">
...
| ------------ | ------------ | ------------ |------------ |
|  معايير التدقيق الدولية   pm 1:30 - 4:30 - `Ph.D.`  | ------------ |  `Med`   08:30-10:00  (434) علم الاحياء الدقيقه (2) |
| ------------ |  نظرية المحاسبه   pm 8:30 - 5:30 - `Ph.D.` | علم كيمياء تحليليه  `Med`  10:00-11:00 (431) |
|   | ------------  |
  محاسبة التكاليف المتقدمة   pm 4:30 - 7:30 - `Ph.D.` | ------------ |   ريادة الأعمال `Med`  (ON LINE ) ن ر 02:00-03:00 |
...
**[Monday]()**   :  Date :  (4 -12 )  -  ريادة الأعمال `Med`  (  12:00-12:30  ) 



**[Tuesday]()**   :  Date :  (5 -12 )  -   لمواطنة الايجابية ومهارات الحياة  `Med`  (  12:00-12:30  ) 



**[Thursday]()**   :  Date :  (7 -12 )  -  كيمياء تحليليه  `Med`  (  12:00-12:30  ) 


**[Saturday]()**  :  Date :  (9 -12 )  -  محاسبة التكاليف المتقدمة   pm 4:30 - 7:30 - `Ph.D.`  




**[Sunday]()**  :   Date :  (10 -12 )  -     Udacity session in 10 Am   .....   الاحياء الدقيقه (2)    `Med`   1:30 - 2:00 .....  pm 8:30 - 5:30 - `Ph.D.`    نظرية المحاسبه  
...
| ------------ | ------------ | ------------ |------------ | ------------ | 
| 9:00 Am- 12:00 - `Ph.D.`-المحاسبه الاسلاميه | ------------ | ------------ |------------ | ------------ | 
| ------------ | TM‎355 `IT`  تقنية الاتصالات   ‎12:00‏ الى ‎14:00 | ------------ | ------------| ------------ |
...
| **[Saturday]()** |**[Sunday]()**| **[Monday]()** |**[Tuesday ]()** | **[Wednesday]()** |**[Thursday]()** |
| ------------ | ------------ | ------------ |------------ | ------------ | ------------ |
| ------------ | 08:30-09:30 `Med`  (428) علم الامراض | 08:30-11:30 `Med` كيمياء حيويه طبيه  (429) |  08:30-09:30 `Med`  (428) علم الامراض  | 08:30-11:30 `Med` كيمياء حيويه طبيه  (429) |  08:30-09:30 `Med`  (428) علم الامراض  |
| - 9:00 Am- 12:00 - `Ph.D.` المحاسبة المالية المتقدمة(بالانجليزي)- | 09:30-10:30 `Med`   (429) علم الاحياء الدقيقه 1 | ------------| `Med`   (429) علم الاحياء الدقيقه 1 | ------------ | `Med`   (429) علم الاحياء الدقيقه 1 |
| ------------ | 10:30-11:30 `Med` (318) مهارات لغوية /انجليزي  | ------------ | 10:30-11:30 `Med` (318) مهارات لغوية /انجليزي  | ------------ | 10:30-11:30 `Med` (318) مهارات لغوية /انجليزي  |
| ------------ | ----  --------  | 11:30-02:30 `Med` علم المناعه  (429) |------------ | 11:30-02:30 `Med` علم المناعه  (429) | ------------ |
| ------------ |  11:30-01:30 `Med` (429) كيمياء سريريه   | ------------ | 11:30-01:30 `Med` (429) كيمياء سريريه  | ------------ | 11:30-01:30 `Med` (429) كيمياء سريريه  |
|  - 13:00 pm- 16:00 - `Ph.D.`  المحاسبة الاداريه المتقدمة(بالانجليزي)-  | ------------ | ------------ |   4:00- 5:00 Online 🕥 TM471-I `IT `  Graduation Project    | ------------ | ------------ |
| ------------ | 5:00- 7:00 Online 🕥 TM354 `IT ` Software Engineering  | ------------ |------------ | ------------ | ------------ |
