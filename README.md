...
| ------------ | ------------ | ------------ |------------ | ------------ | ------------ |------------ |
| ------------ | ------------ | ------------ |------------ | ------------ | ------------ |------------ |
| - 9:00 Am- 12:00 - `Ph.D.` المحاسبة المالية المتقدمة(بالانجليزي)- | ------------ | ------------ |------------ | ------------ | ------------ |------------ |
|  - 13:00 pm- 16:00 - `Ph.D.`  المحاسبة الاداريه المتقدمة(بالانجليزي)-  | ------------ | ------------ |  -------   | ------------ | ------------ |------------ | 
| ------------ | ------------ | ------------ |  4:00- 5:00 Online 🕥 TM471-I   Graduation Project |------------ | ------------ |------------ |
| ------------ | ----  -------- | ------------ |------------ | ------------ | ------------ |------------ | 
| ------------ | ----  -------- | ------------ |------------ | ------------ | ------------ |------------ | 
| ------------ | 5:00- 7:00 Online 🕥 TM354  Software Engineering  | ------------ |------------ | 4:00- 5:00 Online 🕥 TM471-I   Graduation Project | ------------ |------------ |
| ------------ | ----  -------- | ------------ |------------ | ------------ | ------------ |------------ | 
