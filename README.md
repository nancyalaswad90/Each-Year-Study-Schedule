...
|**[Sundayالاحد- 1 ]()**| **[Monday الاثنين ]()** |**[Tuesday الثلاثاء ]()** | **[Wednesday الاربعاء ]()** |**[Thursday الخميس ]()** |
| ------------ | ------------ |------------ | ------------ | ------------ |
| ------------ | ------------ |------------ | - m -الساعة 12  مهارات لغوية   18/1 - | ------------  |
| -m المناعة 22/1 -الساعة 12| ------------ |------------ | ------------ | ------------ | 
| ------------ | ------------ |------------ |  - m الامراض  25/1 -  | |------------  |
| ------------ | ------------ |------------ | ------------ |  - m الكيمياء الطبية  26/1 -  | 
| ------------ |   - m احياء دقيقة   30/1 - |------------ | ------------ | ------------ |
| ------------ |   - m الكيمياء سريرية  30/1 - |------------ | ------------ | ------------ |
.
